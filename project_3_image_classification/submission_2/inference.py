...
# Based on project 4 starter code.
# I don't yet understand what model we are aiming to return in def Net().
# In all cases in my research, a model is newly defined here,
# rather than the trained model (in my case, as defined in model_data).
# I don't understand how the model_data and the model defined in the entry_point of my PyTorchModel relate
# For now, I've gone with redefining the model from train_model.py here:
def Net():
