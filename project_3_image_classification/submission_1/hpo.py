...
def test(model, test_loader, loss_criterion, args):
    '''
...
def train(model, train_loader, validation_loader, loss_criterion, optimizer, args, device):
    '''
...
#   Training our model will go faster if we use the GPU.  
    ...
    '''
    model = train(model, train_loader, validation_loader, loss_criterion, optimizer, args, device)
    
    '''
    TODO: Test the model to see its accuracy
    '''
    test(model, test_loader, loss_criterion, args)
